          ...
          <Grid container spacing={24}>
            <Grid item xs={12}>
              <Card className={classes.card}>
                <Typography type="headline" component="h2" className={classes.title} style={{fontFamily:'Pacifico', fontSize:"1.5rem"}}>
                  Blizzmate
                </Typography>
                <CardMedia className={classes.media} image={friendsImg} title="friends image"/>
                <CardContent>
